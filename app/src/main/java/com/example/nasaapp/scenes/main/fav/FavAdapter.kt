...
class FavAdapter(private var patents: List<Patent>, private val context: Context, private val clickListener: (Patent) -> Unit): RecyclerView.Adapter<FavAdapter.PatentHolder>() {
